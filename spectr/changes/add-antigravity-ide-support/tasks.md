...
- [x] 1.1 Add Antigravity tool definition to `NewRegistry()` in `internal/init/registry.go`
  ...
  - Configured: false
- [x] 1.2 Add Antigravity-to-slash mapping in `configToSlashMapping` variable
  - Key: `antigravity`
...
- [x] 2.2 Implement `Configure()` method
  ...
  - Creates `.antigravity/workflows/spectr-*.md` slash command files
- [x] 2.3 Implement `IsConfigured()` method
  - Checks for `AGENTS.md` file in project path
- [x] 2.4 Implement `GetName()` method
  - Returns `"Antigravity"`
